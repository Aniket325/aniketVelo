...
public void ConfigurationAppium() throws MalformedURLException, InterruptedException
	{
		//chatgptLogger logger = Logger.getLogger(new String("AppiumBasics"));
			...
			//	options.setApp("C:\\Users\\anike\\eclipse-workspace\\Appium\\src\\test\\java\\resourcses\\ApiDemos-debug.apk");
			    options.setApp("C:\\Users\\anike\\eclipse-workspace\\Appium\\src\\test\\java\\resourcses\\General-Store.apk");
